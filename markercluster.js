...
function MarkerClusterer(map, opt_markers, opt_options) {
  ...
  this.gridSize_ = options['gridSize'] || 45;
...
ClusterIcon.prototype.onAdd = function () {
  ...
  google.maps.event.addDomListener(this.div_, 'mouseover', function (event) {
    ...
    $(event.target).append("<div id='ab' style='display:block; width: 42px; height: 20px; position:absolute; top:-20px; background:#313c45;'>" + lang_text + "</div>");
  });
...
ClusterIcon.prototype.createCss = function (pos) {
  ...
  style.push('cursor:pointer; top:' + pos.y + 'px; left:' +
    ...
    txtSize + 'px; font-family:Open Sans; font-size:12px;');
  return style.join('');
};
